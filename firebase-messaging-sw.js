...
console.log('[firebase-messaging-sw.js] Registering for background message handling ...');
...
console.log('[firebase-messaging-sw.js] Registered messaging.onBackgroundMessage');